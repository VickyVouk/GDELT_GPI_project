...
for (i in country_files){
  ...
  if (file.exists(file_df)){
    ...
    for (train_set in train_set_list){
      ...
      write.csv(df_important_var, sprintf('/Users/vickyvoukelatou/Documents/Gdelt/GPI_project/experiment/elnet/%s_elnet_%s_important_variables.csv', country, train_set))
